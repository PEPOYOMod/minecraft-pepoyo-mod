package net.mcreator.pepoyo.world.features;

import com.mojang.serialization.Codec;
import net.mcreator.pepoyo.world.features.configurations.StructureFeatureConfiguration;
...
public class StructureFeature extends Feature<StructureFeatureConfiguration> {
   ...
   public static final RegistryObject<Feature<?>> STRUCTURE_FEATURE;
   ...
   public boolean m_142674_(FeaturePlaceContext<StructureFeatureConfiguration> context) {
      ...
      StructurePlaceSettings placeSettings = (new StructurePlaceSettings()).m_74379_(rotation).m_74377_(mirror).m_230324_(random).m_74392_(false).m_74383_(new BlockIgnoreProcessor(config.ignoredBlocks().m_203614_().map(Holder::get).toList()));
      template.m_230328_(worldGenLevel, placePos, placePos, placeSettings, random, 4);
      return true;
   }

   static {
      REGISTRY = DeferredRegister.create(ForgeRegistries.FEATURES, "pepoyo");
      STRUCTURE_FEATURE = REGISTRY.register("structure_feature", () -> {
