...
public class SoldierEntity extends Monster implements GeoEntity {
   ...
   public SoldierEntity(SpawnEntity packet, Level world) {
      this((EntityType)PepoyoModEntities.SOLDIER.get(), world);
   }
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "soldier");
   }
   ...
   private PlayState movementPredicate(AnimationState event) {
      if (this.animationprocedure.equals("empty")) {
         return !event.isMoving() && event.getLimbSwingAmount() > -0.15F && event.getLimbSwingAmount() < 0.15F ? event.setAndContinue(RawAnimation.begin().thenLoop("animation.soldier.ambient")) : event.setAndContinue(RawAnimation.begin().thenLoop("animation.soldier.walk"));
      } else {
   ...
   private PlayState attackingPredicate(AnimationState event) {
      ...
      if (this.swinging && event.getController().getAnimationState() == State.STOPPED) {
         ...
         return event.setAndContinue(RawAnimation.begin().thenPlay("animation.soldier.attack"));
      } else {
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(SoldierEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(SoldierEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(SoldierEntity.class, EntityDataSerializers.f_135030_);
   }
}
