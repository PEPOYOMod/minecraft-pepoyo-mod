...
import net.mcreator.pepoyo.procedures.YorupoDangShiTiGengXinKeShiProcedure;
import net.mcreator.pepoyo.procedures.YorupoDangYouJiShiTiShiProcedure;
...
public class YorupoEntity extends Monster implements GeoEntity {
   ...
   public YorupoEntity(SpawnEntity packet, Level world) {
      this((EntityType)PepoyoModEntities.YORUPO.get(), world);
   }

   public YorupoEntity(EntityType<YorupoEntity> type, Level world) {
      super(type, world);
   ...
   protected void m_8099_() {
      ...
      this.f_21346_.m_25352_(5, new NearestAttackableTargetGoal(this, ArmorStand.class, false, false));
   ...
   public InteractionResult m_6071_(Player sourceentity, InteractionHand hand) {
      ...
      YorupoDangYouJiShiTiShiProcedure.execute(world, x, y, z, this, sourceentity);
      return retval;
   }

   public void m_6075_() {
      super.m_6075_();
      YorupoDangShiTiGengXinKeShiProcedure.execute(this);
      this.m_6210_();
   }
   ...
   public static void init() {
      SpawnPlacements.m_21754_((EntityType)PepoyoModEntities.YORUPO.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
   ...
   private PlayState movementPredicate(AnimationState event) {
      if (this.animationprocedure.equals("empty")) {
         return !event.isMoving() && event.getLimbSwingAmount() > -0.15F && event.getLimbSwingAmount() < 0.15F ? event.setAndContinue(RawAnimation.begin().thenLoop("animation.yorupo.ambient")) : event.setAndContinue(RawAnimation.begin().thenLoop("animation.yorupo.lurk"));
      } else {
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(YorupoEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(YorupoEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(YorupoEntity.class, EntityDataSerializers.f_135030_);
   }
}
