...
import net.mcreator.pepoyo.procedures.ShindeDangShiTiShouShangShiProcedure;
...
public class ShindeEntity extends Monster implements GeoEntity {
   ...
   public ShindeEntity(SpawnEntity packet, Level world) {
      this((EntityType)PepoyoModEntities.SHINDE.get(), world);
   }
   ...
   public boolean m_6469_(DamageSource source, float amount) {
      ShindeDangShiTiShouShangShiProcedure.execute(this.m_9236_(), this.m_20185_(), this.m_20186_(), this.m_20189_(), source.m_7639_());
   ...
   public EntityDimensions m_6972_(Pose p_33597_) {
      return super.m_6972_(p_33597_).m_20388_(0.7F);
   }

   public static void init() {
      SpawnPlacements.m_21754_((EntityType)PepoyoModEntities.SHINDE.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
   ...
   private PlayState movementPredicate(AnimationState event) {
      if (this.animationprocedure.equals("empty")) {
         return !event.isMoving() && event.getLimbSwingAmount() > -0.15F && event.getLimbSwingAmount() < 0.15F ? event.setAndContinue(RawAnimation.begin().thenLoop("animation.shinde.ambient")) : event.setAndContinue(RawAnimation.begin().thenLoop("animation.shinde.walk"));
      } else {
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(ShindeEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(ShindeEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(ShindeEntity.class, EntityDataSerializers.f_135030_);
   }
}
