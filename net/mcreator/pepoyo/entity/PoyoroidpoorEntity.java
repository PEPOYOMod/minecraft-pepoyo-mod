...
public class PoyoroidpoorEntity extends TamableAnimal implements GeoEntity {
   ...
   public PoyoroidpoorEntity(SpawnEntity packet, Level world) {
      this((EntityType)PepoyoModEntities.POYOROIDPOOR.get(), world);
   }

   public PoyoroidpoorEntity(EntityType<PoyoroidpoorEntity> type, Level world) {
      super(type, world);
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "poyoroid_poor");
   }
   ...
   protected void m_8099_() {
      ...
      this.f_21345_.m_25352_(9, new AvoidEntityGoal(this, Monster.class, 32.0F, 1.0D, 1.2D));
   }
   ...
   public AgeableMob m_142606_(ServerLevel serverWorld, AgeableMob ageable) {
      PoyoroidpoorEntity retval = (PoyoroidpoorEntity)((EntityType)PepoyoModEntities.POYOROIDPOOR.get()).m_20615_(serverWorld);
   ...
   public static void init() {
      SpawnPlacements.m_21754_((EntityType)PepoyoModEntities.POYOROIDPOOR.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
   ...
   public static Builder createAttributes() {
      ...
      builder = builder.m_22268_(Attributes.f_22276_, 20.0D);
      builder = builder.m_22268_(Attributes.f_22284_, 0.0D);
      builder = builder.m_22268_(Attributes.f_22281_, 5.0D);
   ...
   private PlayState movementPredicate(AnimationState event) {
      if (this.animationprocedure.equals("empty")) {
         return !event.isMoving() && event.getLimbSwingAmount() > -0.15F && event.getLimbSwingAmount() < 0.15F ? event.setAndContinue(RawAnimation.begin().thenLoop("animation.poyoriod_poor.ambient")) : event.setAndContinue(RawAnimation.begin().thenLoop("animation.poyoriod_poor.escape"));
      } else {
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(PoyoroidpoorEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(PoyoroidpoorEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(PoyoroidpoorEntity.class, EntityDataSerializers.f_135030_);
   }
}
