...
import net.mcreator.pepoyo.procedures.PoyoDangYouJiShiTiShiProcedure;
...
public class PoyoEntity extends Monster implements GeoEntity {
   ...
   public PoyoEntity(SpawnEntity packet, Level world) {
      this((EntityType)PepoyoModEntities.POYO.get(), world);
   }

   public PoyoEntity(EntityType<PoyoEntity> type, Level world) {
      super(type, world);
   ...
   protected void m_8097_() {
      ...
      this.f_19804_.m_135372_(TEXTURE, "poyo");
   }
   ...
   public InteractionResult m_6071_(Player sourceentity, InteractionHand hand) {
      ...
      PoyoDangYouJiShiTiShiProcedure.execute(world, this, sourceentity);
      return retval;
   }
   ...
   public static void init() {
      SpawnPlacements.m_21754_((EntityType)PepoyoModEntities.POYO.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(PoyoEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(PoyoEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(PoyoEntity.class, EntityDataSerializers.f_135030_);
   }
}
