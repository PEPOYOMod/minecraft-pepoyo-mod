...
import net.mcreator.pepoyo.procedures.PoyoroidDangYouJiShiTiShiProcedure;
...
public class PoyoroidEntity extends TamableAnimal implements GeoEntity {
   ...
   public PoyoroidEntity(SpawnEntity packet, Level world) {
      this((EntityType)PepoyoModEntities.POYOROID.get(), world);
   }

   public PoyoroidEntity(EntityType<PoyoroidEntity> type, Level world) {
      super(type, world);
   ...
   protected void m_8099_() {
      ...
      this.f_21345_.m_25352_(5, new OwnerHurtByTargetGoal(this));
      this.f_21346_.m_25352_(6, new OwnerHurtTargetGoal(this));
   ...
   public InteractionResult m_6071_(Player sourceentity, InteractionHand hand) {
      ...
      PoyoroidDangYouJiShiTiShiProcedure.execute(world, x, y, z, this, sourceentity);
      return retval;
   }
   ...
   public AgeableMob m_142606_(ServerLevel serverWorld, AgeableMob ageable) {
      PoyoroidEntity retval = (PoyoroidEntity)((EntityType)PepoyoModEntities.POYOROID.get()).m_20615_(serverWorld);
   ...
   public boolean m_6898_(ItemStack stack) {
      return List.of(new Item[]{Items.f_42410_, Items.f_42436_, Items.f_42437_, Items.f_42399_, Items.f_42400_, Items.f_42718_, Items.f_42401_, Items.f_42402_, Items.f_42403_, Items.f_42404_, Items.f_42405_, Items.f_42619_, Items.f_42620_, Items.f_42674_, Items.f_42675_, Items.f_42687_, Items.f_42677_, Items.f_42406_, Items.f_42576_, Items.f_42518_, Items.f_42521_, Items.f_42525_, Items.f_42500_, Items.f_42501_, Items.f_42502_, Items.f_42503_, Items.f_42572_, Items.f_42575_, Items.f_42578_, Items.f_42780_, Items.f_151079_, Items.f_42526_, Items.f_42527_, Items.f_42528_, Items.f_42529_, Items.f_42530_, Items.f_42531_, Items.f_42485_, Items.f_42486_, Items.f_42579_, Items.f_42580_, Items.f_42581_, Items.f_42582_, Items.f_42697_, Items.f_42698_, Items.f_42648_, Items.f_42649_, Items.f_42699_, Items.f_42658_, Items.f_42659_, Items.f_42583_, Items.f_42589_}).contains(stack.m_41720_());
   }
   ...
   public static void init() {
      SpawnPlacements.m_21754_((EntityType)PepoyoModEntities.POYOROID.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
   ...
   public static Builder createAttributes() {
      ...
      builder = builder.m_22268_(Attributes.f_22276_, 100.0D);
      builder = builder.m_22268_(Attributes.f_22284_, 0.0D);
      builder = builder.m_22268_(Attributes.f_22281_, 4.0D);
   ...
   static {
      SHOOT = SynchedEntityData.m_135353_(PoyoroidEntity.class, EntityDataSerializers.f_135035_);
      ANIMATION = SynchedEntityData.m_135353_(PoyoroidEntity.class, EntityDataSerializers.f_135030_);
      TEXTURE = SynchedEntityData.m_135353_(PoyoroidEntity.class, EntityDataSerializers.f_135030_);
   }
}
