...
import net.mcreator.pepoyo.procedures.RamenDangWanJiaWanChengShiYongWuPin1ShiProcedure;
...
public class RamenItem extends Item {
   public RamenItem() {
      super((new Properties()).m_41487_(5).m_41486_().m_41497_(Rarity.COMMON).m_41489_((new Builder()).m_38760_(12).m_38758_(0.3F).m_38765_().m_38757_().m_38767_()));
   }
   ...
   public ItemStack m_5922_(ItemStack itemstack, Level world, LivingEntity entity) {
      ...
      RamenDangWanJiaWanChengShiYongWuPin1ShiProcedure.execute(entity);
