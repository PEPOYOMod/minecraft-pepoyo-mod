...
public class RamenbowlRenderer extends EntityRenderer<RamenbowlEntity> {
   ...
   public RamenbowlRenderer(Context context) {
      super(context);
      this.model = new Modelramen_boom(context.m_174023_(Modelramen_boom.LAYER_LOCATION));
   }

   public void render(RamenbowlEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
   ...
   public ResourceLocation getTextureLocation(RamenbowlEntity entity) {
      return texture;
   }
}
