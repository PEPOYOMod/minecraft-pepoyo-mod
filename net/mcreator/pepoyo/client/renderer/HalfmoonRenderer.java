...
public class HalfmoonRenderer extends EntityRenderer<HalfmoonEntity> {
   private static final ResourceLocation texture = new ResourceLocation("pepoyo:textures/entities/half_moon.png");
   private final Modelhalf_moon model;

   public HalfmoonRenderer(Context context) {
      super(context);
      this.model = new Modelhalf_moon(context.m_174023_(Modelhalf_moon.LAYER_LOCATION));
   }

   public void render(HalfmoonEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
   ...
   public ResourceLocation getTextureLocation(HalfmoonEntity entity) {
      return texture;
   }
}
