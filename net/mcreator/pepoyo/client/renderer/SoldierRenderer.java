...
import net.mcreator.pepoyo.entity.model.SoldierModel;
...
public class SoldierRenderer extends GeoEntityRenderer<SoldierEntity> {
   public SoldierRenderer(Context renderManager) {
   ...
   public void preRender(PoseStack poseStack, SoldierEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
      float scale = 1.2F;
