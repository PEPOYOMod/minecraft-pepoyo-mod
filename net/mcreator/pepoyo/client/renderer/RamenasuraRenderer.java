...
public class RamenasuraRenderer extends EntityRenderer<RamenasuraEntity> {
   private static final ResourceLocation texture = new ResourceLocation("pepoyo:textures/entities/ramen_bowl.png");
   private final Modelramen_boom model;

   public RamenasuraRenderer(Context context) {
      super(context);
      this.model = new Modelramen_boom(context.m_174023_(Modelramen_boom.LAYER_LOCATION));
   }

   public void render(RamenasuraEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
   ...
   public ResourceLocation getTextureLocation(RamenasuraEntity entity) {
      return texture;
   }
}
