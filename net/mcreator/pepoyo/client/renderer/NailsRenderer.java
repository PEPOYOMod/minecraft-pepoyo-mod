...
public class NailsRenderer extends EntityRenderer<NailsEntity> {
   private static final ResourceLocation texture = new ResourceLocation("pepoyo:textures/entities/nail.png");
   private final Modelnail model;

   public NailsRenderer(Context context) {
      super(context);
      this.model = new Modelnail(context.m_174023_(Modelnail.LAYER_LOCATION));
   }

   public void render(NailsEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
   ...
   public ResourceLocation getTextureLocation(NailsEntity entity) {
      return texture;
   }
}
