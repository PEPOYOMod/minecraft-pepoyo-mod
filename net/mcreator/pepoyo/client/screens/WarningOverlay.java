...
public class WarningOverlay {
   ...
   public static void eventHandler(Pre event) {
      ...
      if (DarkscreensDangYaoShuiXiaoGuoKaiShiYingYongShiProcedure.execute(entity)) {
         event.getGuiGraphics().m_280163_(new ResourceLocation("pepoyo:textures/screens/warning.png"), 0, 0, 0.0F, 0.0F, w, h, w, h);
      }
